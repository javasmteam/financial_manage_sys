...
values (com_id, '招商银行', '03968', 'img/招商银行.webp', 'img/招商银行app.webp', '银行', '1987', '缪建民', '广东', 1.5, 13,
        ...
        com_info_state);
insert into company_info
values (com_id, '猫眼娱乐', '01896', 'img/猫眼娱乐.webp', 'img/猫眼娱乐app.webp', '媒体及娱乐', '2017', '王长田', '香港', 1.5, 14,
        '猫眼娱乐是一家主要运营创新互联网娱乐服务平台的中国公司,公司寻求建立一个围绕本公司综合性平台的充满活力的生态系统,连接并赋能消费者和娱乐行业,达成本公司的使命。本公司致力于借助互联网的力量使消费者能够轻松发现和享受高质量的娱乐内容。',
        com_info_state);
insert into company_info
values (com_id, '利福国际', '01212', 'img/利福国际.webp', 'img/利福国际app.gif', '专业零售', '2003', '刘銮鸿', '香港', 1.5, 15,
